...
class BaseModelPTV2Wrapper(nn.Module):
    def __init__(self, base_lm, config_peft):
        ...
        self.llama = True if self.config_peft.model.base_model in ["Llama2_7b"] else False
        self.num_virtual_tokens = self.config_peft.model.layer_num_virtual_tokens
