...
from models.modules.cross_attention import CrossAttentionBlock
...
class Aggregator(nn.Module):
    def __init__(self, config, question_encoder, baselm_token_dim, amort_enc_dim,
                 num_virtual_tokens, dropout_p=0.):
        super().__init__()
        self.config = config
        ...
        num_cross_attention_blocks = self.config.model.num_cross_attention_blocks
